...
def create_voting_dict(strlist):
    ...
    """
    return {row.split()[0]: [int(x) for x in row.split()[3:]] for row in strlist}
...
most_average_Democrat = False # give the last name (or code that computes the last name)
...
average_Democrat_record = False # give the vector as a list
